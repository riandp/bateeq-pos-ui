...
export class App {
  ...
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'void-sales', name: 'void-sales', moduleId: './modules/void-sales-cr/index', nav: true, title: 'void sales',settings: { group:"transaction", roles:["admin"] } }, 
      { route: 'report-payment-method', name: 'report-payment-method', moduleId: './modules/report-payment-method/index', nav: true, title: 'report payment method',settings: { group:"transaction", roles:["admin"] } },
      { route: 'report-void-sales', name: 'report-void-sales', moduleId: './modules/report-void-sales/index', nav: true, title: 'report void sales',settings: { group:"transaction", roles:["admin"] } }
    ]);
